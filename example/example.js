...
},{"@barchart/tgam-jwt-js/lib/JwtGateway":28}],2:[function(require,module,exports){
'use strict';
  ...
  */
	...
	var WatchlistGateway = function (_Disposable) {
		...
		function WatchlistGateway(protocol, host, port, requestInterceptor) {
			...
			_this._readServiceMetadataEndpoint = EndpointBuilder.for('read-service-metadata').withVerb(VerbType.GET).withProtocol(protocolType).withHost(host).withPort(port).withPathBuilder(function (pb) {
			...
			_this._readUserEndpoint = EndpointBuilder.for('read-user').withVerb(VerbType.GET).withProtocol(protocolType).withHost(host).withPort(port).withPathBuilder(function (pb) {
			...
			_this._writeUserEndpoint = EndpointBuilder.for('write-user').withVerb(VerbType.PUT).withProtocol(protocolType).withHost(host).withPort(port).withPathBuilder(function (pb) {
				return pb.withLiteralParameter('v1').withLiteralParameter('user');
...
},{"@barchart/common-client-js/http/Gateway":4,"@barchart/common-client-js/http/builders/EndpointBuilder":5,"@barchart/common-client-js/http/definitions/Endpoint":9,"@barchart/common-client-js/http/definitions/ProtocolType":12,"@barchart/common-client-js/http/definitions/VerbType":13,"@barchart/common-client-js/http/interceptors/RequestInterceptor":16,"@barchart/common-client-js/http/interceptors/ResponseInterceptor":17,"@barchart/common-js/lang/Disposable":18,"@barchart/common-js/lang/Enum":19,"@barchart/common-js/lang/assert":22,"@barchart/common-js/lang/is":24,"@barchart/common-js/timing/Scheduler":27}],29:[function(require,module,exports){
