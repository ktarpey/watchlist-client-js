 ...
 * @property {Schema.WatchlistEntry[]} entries - The ordered list of watchlist items (i.e. investments).
 * @property {Schema.WatchlistPreferences} preferences - An object containing display preferences (e.g. sort order for entries). This property can be omitted when creating a new watchlist.
 */
