...
module.exports = (() => {
	...
	class WatchlistGateway extends Disposable {
		...
		/**
		 * Updates the preference data for an existing watchlist.
		 *
		 * @public
		...
		/**
		 * Subscribes to changes to watchlists (requires native WebSocket support). Notifications
		 ...
		 *
		 * @public
		 * @param {Callbacks.SubscriptionMessageCallback} messageCallback
		 * @param {Callbacks.SubscriptionStatusCallback} statusCallback
		 * @returns {Promise}
		 */
		...
		/**
		 * Retrieves infomration regarding the remote service (e.g. version number, current user identifier, etc).
		 *
		 * @public
