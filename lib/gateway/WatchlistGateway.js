...
module.exports = (() => {
	...
	class WatchlistGateway extends Disposable {
		...
		/**
		 * Subscribes watchlists. The Only one subscription is supported. Invoking this
		...
		static forTest(jwtProvider) {
			return Promise.resolve()
				.then(() => {
					...
					return start(new WatchlistGateway(REST_API_SECURE_PROTOCOL, Configuration.testHost, REST_API_SECURE_PORT, 'development', WEBSOCKET_SECURE_PROTOCOL, Configuration.testHostForWebSocket), jwtProvider);
				});
		}
