		...
		static forTest(requestInterceptor) {
			return Promise.resolve(requestInterceptor)
				.then((requestInterceptor) => {
					...
					return start(new WatchlistGateway(REST_API_SECURE_PROTOCOL, Configuration.testHost, REST_API_SECURE_PORT, 'development', requestInterceptor, WEBSOCKET_SECURE_PROTOCOL, Configuration.testtHostForWebSocket));
				});
		}
