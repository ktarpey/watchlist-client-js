			...
			return Promise.resolve(requestInterceptor).then((requestInterceptor) => {
				...
				return start(
					new WatchlistGateway(
						...
						requestInterceptor,
						'wss',
						'6tyutdt1lf.execute-api.us-east-1.amazonaws.com/dev'
					)
				);
			});
		}
			...
			return Promise.resolve(requestInterceptor).then((requestInterceptor) => {
				...
				return start(
					new WatchlistGateway(
						...
						requestInterceptor,
						'wss',
						'85i5mijnnb.execute-api.us-east-1.amazonaws.com/stage'
					)
				);
			});
		}
			...
			return Promise.resolve(requestInterceptor).then((requestInterceptor) => {
				...
				return start(
					new WatchlistGateway(
						...
						requestInterceptor,
						'wss',
						'lufdkfctyk.execute-api.us-east-1.amazonaws.com/prod'
					)
				);
			});
		}
